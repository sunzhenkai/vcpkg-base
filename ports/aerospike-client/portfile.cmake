...
if(NOT EXISTS "${SOURCE_PATH}/.git")
  ...
  # apply patch
  vcpkg_apply_patches(SOURCE_PATH ${SOURCE_PATH} PATCHES openssl.patch)
endif()
...
# install prefix fixup: 由于 aerospike client 没有 configure 脚本，所以需要手动设置安装路径
# INSTALL_PREFIX INSTALL_PREFIX 是代码文件 pkg/install 内定义的 这里的 INSTALL_PREFIX 是
# {prefix_dir}/{install_dir} vcpkg_configure_make 默认会指定 --prefix, 但是这里没有
# configure 脚本，添加了 SKIP_CONFIGURE 选项 因此这里修复 INSTALL_PREFIX 为
# {prefix_dir}/{install_dir} 不然这里会报错:
# https://github.com/microsoft/vcpkg/blob/master/scripts/cmake/vcpkg_build_make.cmake#L177C8-L177C102
# 报错代码： file(RENAME "${CURRENT_PACKAGES_DIR}_tmp${Z_VCPKG_INSTALL_PREFIX}"
# "${CURRENT_PACKAGES_DIR}")
string(REGEX REPLACE "([a-zA-Z]):/" "/\\1/" Z_VCPKG_INSTALL_PREFIX
...
vcpkg_configure_make(SOURCE_PATH "${SOURCE_PATH}" COPY_SOURCE SKIP_CONFIGURE
                     OPTIONS "CURRENT_INSTALLED_DIR=${CURRENT_INSTALLED_DIR}")
vcpkg_build_make(DISABLE_PARALLEL)
vcpkg_install_make()
...
message(
  STATUS
    "recover ENV{INSTALL_PREFIX}: ${ENV_INSTALL_PREFIX_} - $ENV{INSTALL_PREFIX}"
)
